        ...
        <section class="bg-white scroll-mt-20" id="about-us">
            <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                ...
                <div class="grid grid-cols-2 gap-4 mt-8">
                    <img class="w-full rounded-lg" src="/images/about-us-1.webp" loading="lazy" alt="Trade team at work">
                    <img class="mt-4 w-full lg:mt-10 rounded-lg" src="/images/about-us-2.webp" loading="lazy" alt="Completed trade project">
                </div>
